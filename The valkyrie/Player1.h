...
class JudgeDredd::Valkyrie
{
	...
	private:
		...
		bool amIWhite;
		ChessEvaluator::ChessEvaluation Play(const ChessBoard::Board *currentBoard, short int currentRecursion, short int maxRecursion, ChessBoard::InternalMove *chosenMove, bool isWhite);
